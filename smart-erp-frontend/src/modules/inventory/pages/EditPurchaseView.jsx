  ...
  return (
    <PageContainer>
      ...
      {!loading && !error && purchase && (
        <PurchaseForm initialData={purchase} onSave={handleSave} onCancel={() => navigate(`/inventory/purchases/${id}`)} companyState={activeCompany ? activeCompany.state : ''} loading={submitting} />
      )}
    </PageContainer>
  );
}
