...
import { useRegisterForm } from '@modules/auth/services/auth.service';
...
export default function RegisterView({ onRegisterSuccess, onLoginClick }) {
  const { error, errors, loading, handleSubmit, nameBind, emailBind, passwordBind, roleBind } = useRegisterForm(onRegisterSuccess);
